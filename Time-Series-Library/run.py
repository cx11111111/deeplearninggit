...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str,  default='WindPower', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/windpower/', help='root path of the data file')
